...
py_input_args=(--out $HDFS_BASE/residency_daily --lookback 30 --keep-days 400)
# log all to stdout
spark-submit "${spark_submit_args[@]}" "$script_dir/residency_daily_rollup.py" "${py_input_args[@]}" 2>&1
